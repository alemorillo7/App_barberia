...
const adminLogin = async () => {
  ...
  console.log("Datos de Firebase: ", data.docs.map((doc) => doc.data()));  // Ver qué datos llegan desde Firebase
  console.log("Valores ingresados: ", {
    email: emailField.current.value,
    phone: passwordField.current.value,
    credential: adminField.current ? adminField.current.value : null,
  });  // Ver los valores ingresados

  const admin = data.docs.find(
    (admin) =>
      admin.data().email === emailField.current.value &&
    String(admin.data().phone) === passwordField.current.value &&  // Convertir phone a cadena
